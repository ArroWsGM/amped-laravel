 ...
 */
class IframeSanitizer extends AMP_Base_Sanitizer {
    use AMP_Noscript_Fallback;
     ...
     * @const int
     */
    const SANDBOX_DEFAULTS = 'allow-scripts allow-same-origin allow-presentation';
    ...
    public function sanitize() {
        ...
        for ( $i = $num_nodes - 1; $i >= 0; $i-- ) {
            ...
            $normalized_attributes = AmpDom::get_node_attributes_as_assoc_array( $node );
            ...
            $new_node = AmpDom::create_node( $this->dom, 'amp-iframe', $normalized_attributes );
    ...
    private function build_placeholder( $parent_attributes ) {
        $placeholder_node = AmpDom::create_node(
            $this->dom,
            'span',
            [
                'placeholder' => '',
