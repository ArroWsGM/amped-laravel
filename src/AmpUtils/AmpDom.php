...
class AmpDom {
	 ...
	 *
	 * @since 0.7
	 * @see AmpDom::get_content_from_dom_node()
	 *
				...
				static function( $head_matches ) {
					return preg_replace_callback(
						...
						static function( $noscript_matches ) {
                            ...
                            AmpDom::$noscript_placeholder_comments[ $placeholder ] = $noscript_matches[0];
							return $placeholder;
						},
						$head_matches[0]
					);
	 ...
	 *
	 * @since 0.7
	 * @see \AmpDom::convert_amp_bind_attributes()
	 * @see \AmpDom::restore_amp_bind_attributes()
	 * @deprecated Use AmpDom::AMP_BIND_DATA_ATTR_PREFIX alone.
	 ...
	 * This is a reciprocal function of AmpDom::restore_amp_bind_attributes().
	 *
	 * @since 0.7
	 * @see \AmpDom::convert_amp_bind_attributes()
	 * @link https://www.ampproject.org/docs/reference/components/amp-bind
	 ...
	 *
	 * This is a reciprocal function of AmpDom::convert_amp_bind_attributes().
	 *
	 * @since 0.7
	 * @see \AmpDom::convert_amp_bind_attributes()
	 ...
	 *
	 * @since 0.2
	 * @see AmpDom::get_content_from_dom_node() Reciprocal function.
	 *
	 ...
	 *
	 * @since 0.6
	 * @see AmpDom::get_dom() Where the operations in this method are mirrored.
	 * @see AmpDom::get_content_from_dom() Reciprocal function.
